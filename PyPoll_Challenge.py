...
largest_county_name= ""
largest_county_count= -float("inf")
largest_county_percent= -float("inf")
...
with open(file_to_load) as election_data:
    ...
    for row in reader:
        ...
        if largest_county_name not in candidate_counties:

            # 4b: Add the existing county to the list of counties.
            candidate_counties.append(largest_county_name)

            # 4c: Begin tracking the county's vote count.
            candidate_dict[largest_county_name] = 0

        # 5: Add a vote to that county's vote count.
        candidate_dict[largest_county_name] += 1
...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in candidate_dict:
        ...
        if (county_vote > largest_county_count) and (county_percentage > largest_county_percent):
    ...
    largestCounty = (
        ...
        f'Largest County Voter Turnout= {largest_county_name}\n'
       # f'Largest Count Percentage= {largest_county_percent:.1f}%\n'
        f'--------------------------------\n')
    print(largestCounty)
